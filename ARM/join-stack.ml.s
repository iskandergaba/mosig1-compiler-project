...
label3: PUSH   {r4-r11, lr}             @ Function _
        ...
        ADD    r5, r6, r5              
        B      label5                  
label4: MOV    r5, #2                   @ let var37 = ? in...
        ADD    r5, r4, r5              
label5: MOV    r6, #123                 @ let var38 = ? in...
        ADD    r5, r5, r6              
        ADD    r4, r5, r4               @ let var39 = ? in...
        MOV    r0, r4                   @ let var40 = ? in...
        PUSH   {r0}                    
