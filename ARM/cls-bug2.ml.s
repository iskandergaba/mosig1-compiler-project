...
label1: PUSH   {r4-r11, lr}             @ Function _fun0
        ADD    r11, sp, #0             
        SUB    sp, sp, #32             
        MOV    r4, #0                   @ let var0 = ? in...
        LDR    r5, [fp, #40]           
        CMP    r4, r5                  
        BGT    label2                  
        LDR    r5, [fp, #40]            @ let var2 = ? in...
        MOV    r0, r5                  
        PUSH   {r0}                    
        ...
        ADD    sp, sp, #4              
        POP    {r0, r1}                
        LDR    r6, [fp, #40]            @ let var7 = ? in...
        MOV    r7, #1                  
        SUB    r5, r6, r7              
        MOV    r6, #0                   @ let var10 = ? in...
        LSL    r6, #2                  
        ADD    r4, r4, r6              
        LDR    r4, [r4]                
        MOV    r0, r5                   @ let var6 = ? in...
        MOV    r1, r4                  
        LDR    r6, [r4]                
        PUSH   {r0, r1}                
