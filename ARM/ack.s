...
label2: LDR    r5, [fp, #44]           
        ...
        CMP    r5, r6                  
        BGT    label4                  
        LDR    r5, [fp, #40]            @ let var35 = ? in...
        MOV    r6, #1                  
        SUB    r4, r5, r6              
        MOV    r5, #1                   @ let var36 = ? in...
        MOV    r0, r4                   @ let var38 = ? in...
        MOV    r1, r5                  
        LDR    r6, [fp, #48]           
        MOV    r2, r6                  
        LDR    r7, [fp, #48]           
        ...
        MOV    r0, r4                  
        B      label5                  
label4: LDR    r6, [fp, #40]            @ let var40 = ? in...
        MOV    r7, #1                  
        SUB    r4, r6, r7              
        LDR    r6, [fp, #44]            @ let var42 = ? in...
        MOV    r7, #1                  
        SUB    r5, r6, r7              
        LDR    r6, [fp, #40]            @ let var44 = ? in...
        MOV    r0, r6                  
        MOV    r1, r5                  
        LDR    r6, [fp, #48]           
        MOV    r2, r6                  
...
label6: PUSH   {r4-r11, lr}             @ Function _
        ...
        STR    r5, [r6, r4]            
        MOV    r5, r7                  
        MOV    r5, #3                   @ let var47 = ? in...
        MOV    r4, #10                  @ let var48 = ? in...
        MOV    r0, r5                   @ let var50 = ? in...
        MOV    r1, r4                  
        LDR    r6, [fp, #-4]           
        MOV    r2, r6                  
        LDR    r7, [fp, #-4]           
