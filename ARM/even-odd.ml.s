...
label1: PUSH   {r4-r11, lr}             @ Function _fun3
        ADD    r11, sp, #0             
        SUB    sp, sp, #40             
        LDR    r4, [fp, #-4]            @ let fun2_self_clos = ? in...
        LDR    r4, [fp, #36]           
        MOV    r5, #4                  
        LSL    r5, #2                  
        ADD    r4, r4, r5              
        ...
        CMP    r4, r6                  
        BGT    label2                  
        MOV    r4, #0                   @ let var43 = ? in...
        LDR    r6, [fp, #40]           
        CMP    r4, r6                  
        BGT    label4                  
        MOV    r0, r5                  
        B      label5                  
label4: LDR    r6, [fp, #40]            @ let var45 = ? in...
        MOV    r7, #1                  
        ADD    r4, r6, r7              
        MOV    r0, r4                   @ let var47 = ? in...
        LDR    r6, [fp, #-4]           
        MOV    r1, r6                  
        LDR    r7, [fp, #-4]           
        LDR    r6, [r7]                
...
label5: MOV    r0, r4                  
        B      label3                  
label2: LDR    r6, [fp, #40]            @ let var40 = ? in...
        MOV    r7, #1                  
        SUB    r4, r6, r7              
        MOV    r0, r4                   @ let var42 = ? in...
        LDR    r6, [fp, #-4]           
        MOV    r1, r6                  
        LDR    r7, [fp, #-4]           
        LDR    r6, [r7]                
...
label6: PUSH   {r4-r11, lr}             @ Function _fun2
        ADD    r11, sp, #0             
        SUB    sp, sp, #60             
        LDR    r4, [fp, #36]            @ let var37 = ? in...
        MOV    r5, #4                  
        ...
        MOV    r0, r6                  
        B      label10                 
label9: LDR    r7, [fp, #40]            @ let var55 = ? in...
        MOV    r8, #1                  
        ADD    r4, r7, r8              
        MOV    r0, r4                   @ let var57 = ? in...
        LDR    r7, [fp, #-4]           
        MOV    r1, r7                  
        LDR    r8, [fp, #-4]           
        LDR    r7, [r8]                
...
label10: MOV    r0, r4                  
         B      label8                  
label7: LDR    r7, [fp, #40]            @ let var50 = ? in...
        MOV    r8, #1                  
        SUB    r4, r7, r8              
        MOV    r0, r4                   @ let var52 = ? in...
        LDR    r7, [fp, #-4]           
        MOV    r1, r7                  
        LDR    r8, [fp, #-4]           
        LDR    r7, [r8]                
...
label11: PUSH   {r4-r11, lr}             @ Function _
         ADD    r11, sp, #0             
         SUB    sp, sp, #40             
         LDR    r4, [fp, #-8]            @ let var36 = ? in...
         MOV    r4, #123                
         STR    r4, [fp, #-8]           
         LDR    r5, =#456                @ let var37 = ? in...
         LDR    r4, [fp, #-4]            @ let fun2 = ? in...
         MOV    r4, #12                 
         LDR    r6, heap_start          
         LDR    r7, heap_offset         
         LDR    r8, [r6]                
         ...
         MOV    r4, r8                  
         STR    r4, [fp, #-4]           
         LDR    r4, =label6              @ let addr_fun2 = ? in...
         ...
         STR    r6, [r8, r7]            
         MOV    r4, r9                  
         LDR    r4, =#789                @ let var58 = ? in...
         MOV    r0, r4                   @ let var60 = ? in...
         LDR    r6, [fp, #-4]           
         MOV    r1, r6                  
         LDR    r7, [fp, #-4]           
         LDR    r6, [r7]                
