...
label2: LDR    r5, [fp, #40]           
        ...
        CMP    r5, r6                  
        BGT    label4                  
        LDR    r5, [fp, #44]            @ let var20 = ? in...
        LDR    r6, [fp, #40]           
        SUB    r4, r5, r6              
        LDR    r5, [fp, #40]            @ let var22 = ? in...
        MOV    r0, r5                  
        MOV    r1, r4                  
        LDR    r5, [fp, #48]           
        MOV    r2, r5                  
        ...
        MOV    r0, r4                  
        B      label5                  
label4: LDR    r5, [fp, #40]            @ let var23 = ? in...
        LDR    r6, [fp, #44]           
        SUB    r4, r5, r6              
        LDR    r5, [fp, #44]            @ let var25 = ? in...
        MOV    r0, r5                  
        MOV    r1, r4                  
        LDR    r5, [fp, #48]           
        MOV    r2, r5                  
...
label6: PUSH   {r4-r11, lr}             @ Function _
        ...
        STR    r5, [r6, r4]            
        MOV    r5, r7                  
        LDR    r5, =#21600              @ let var26 = ? in...
        LDR    r4, =#337500             @ let var27 = ? in...
        MOV    r0, r5                   @ let var29 = ? in...
        MOV    r1, r4                  
        LDR    r6, [fp, #-4]           
        MOV    r2, r6                  
        LDR    r7, [fp, #-4]           
